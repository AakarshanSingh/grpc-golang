...
const file_proto_main_proto_rawDesc = "" +
	...
	"\tCalculate\x125\n" +
	"\x03add\x12\x16.calculator.AddRequest\x1a\x16.calculator.AddReponseB\x15Z\x13proto/gen;mainapipbb\x06proto3"
...
var file_proto_main_proto_depIdxs = []int32{
	...
	1, // 1: calculator.Calculate.add:output_type -> calculator.AddReponse
