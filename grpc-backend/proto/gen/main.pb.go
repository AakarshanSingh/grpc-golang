...
func (x *AddReponse) GetSum() int32 {
	if x != nil {
		return x.Sum
	}
	return 0
...
const file_main_proto_rawDesc = "" +
	...
	"\tCalculate\x125\n" +
	"\x03add\x12\x16.calculator.AddRequest\x1a\x16.calculator.AddReponse2H\n" +
	"\bGreeting\x12<\n" +
...
var file_main_proto_goTypes = []any{
	...
	(*AddReponse)(nil),    // 1: calculator.AddReponse
...
var file_main_proto_depIdxs = []int32{
	...
	2, // 1: calculator.Greeting.Greet:input_type -> calculator.HelloRequest
	1, // 2: calculator.Calculate.add:output_type -> calculator.AddReponse
	3, // 3: calculator.Greeting.Greet:output_type -> calculator.HelloResponse
